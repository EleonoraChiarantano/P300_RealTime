...
def start(console_inlet):
    ...
    grating = visual.GratingStim(
        ...
        ori=0.0, pos=(0.0, 0.0), size=(0.5, 0.5), sf=10, phase=0.5,
    ...
    while not stop:
        ...
        for thisTrial in trials:
            ...
            while invert_list[0] == 'C':
                shuffle(invert_list)
            grating.color = 'black' if invert_list[invert_idx] == 0 else 'white'
            event_marker = 'F' if invert_list[invert_idx] == 0 else 'R'
            invert_idx += 1
            if invert_idx == 8:
                invert_idx = 0
                shuffle(invert_list)
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                # *grating* updates
                if grating.status == NOT_STARTED and tThisFlip >= args.isi - frameTolerance:
